...
{ Copyright (c) 2017 Albert Molina -   2018 MicroCoin Developers
       ...
       Op := TNodeNotifyEvents(Sender).Node.Operations.OperationsHashTree.GetOperation(i);
{
       ...
       Amount := TAccountComp.FormatMoney(OPR.Amount*-1);
       Fee := TAccountComp.FormatMoney(OPR.Fee);
       Balance := TAccountComp.FormatMoney(OPR.balance);
