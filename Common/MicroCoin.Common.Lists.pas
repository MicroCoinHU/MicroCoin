...
type
  ...
  public
    ...
    procedure AppendFrom(Sender: TOrderedList);
...
procedure TOrderedList.AppendFrom(Sender: TOrderedList);
var
  i: integer;
begin
  for i := 0 to sender.Count - 1 do Add(Sender.Get(i));
end;
...
procedure TOrderedList.Delete(index: integer);
begin
